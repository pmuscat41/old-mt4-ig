...
input ENUM_PM_TRADE_DIRECTION   InpDirection=LONG_TRADE;// Trade long or Trade short?
...
if (!newBar()) return;
   ...
   if (InpDirection==LONG_TRADE) dirstr="long"; else dirstr="short";
