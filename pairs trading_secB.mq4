...
input double order_size=                  1.07;// hedge ratio (2 decimal places)
...
//ord1= orderExecute (ORDER_TYPE_BUY,Sec_a,0,0,order_size,inpTradeComments,inpMagicNumber);
//}
...
if (ord2>0) {Status=INALONG;return;}
}
}
...
//while (ord2<0)
//{
//ord2= orderExecute (ORDER_TYPE_SELL,Sec_a,0,0,order_size,inpTradeComments,inpMagicNumber);

if (ord1>0) {Status=INASHORT;return;}
}
}
