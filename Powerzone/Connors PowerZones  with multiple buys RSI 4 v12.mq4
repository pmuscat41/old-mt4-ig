...
input double               inpOversoldLevel2  =  25.0;          // Oversold Level 2
input double               inpOverboughtLevel2=  75.0;          // Overbought Level 2
...
input string   inpTradeComments  =  "Connors PowerZones Strategy v12";  //Trade comment
