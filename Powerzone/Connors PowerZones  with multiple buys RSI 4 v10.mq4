...
double               inpOversoldLevel2  =  20.0;          // Oversold Level 2
double               inpOverboughtLevel2=  80.0;          // Overbought Level 2
...
input string   inpTradeComments  =  "Connors PowerZones Strategy v10";  //Trade comment
