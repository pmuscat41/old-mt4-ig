...
input string   inpTradeComments  =  "Connors 15M ADX breakout v9";  //Trade comment
...
if (longsignal==true && ticket<=0&& ADX>30) 
   ...
   ticket=PendingOrderOpen(OP_BUYSTOP,inpOrderSize,inpTradeComments,inpMagicNumber, TriggerHigh,TriggerHigh-TriggerLow,TakeProfit,0);tradelong=true;
