...
input string   inpTradeComments  =  "Hedging EA v12";  //Trade comment
...
void OnTick()
  {
   ...
   /// manage trade
      ...
      ApplyTrailingStop (Symbol(),inpMagicNumber,takeProfit);
...
void ApplyTrailingStop(string symbol, int magicNumber, double TP)
