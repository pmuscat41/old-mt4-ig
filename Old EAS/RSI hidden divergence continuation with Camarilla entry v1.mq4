...
////v4 full working version - ichimuuko cloud stops
...
int   input    inplookback          = 5;  // lookback period?
...
input string   inpTradeComments  =  "Macd divergence with camarilla v4";  //Trade comment
                      ...
                      //near keltner
                        ...
                        double KeltnerLowerBand     = KeltnerMovingAverage-KeltnerBandShift; 
                         ...
                         priceExtreme=false;
                          ...
                          if ((rsilow>rsihigh) && (goShort==true) &&  (notrade==false)&& (notDiverging==false) && 
                       ...
                       //// lOOK FOR rsi DIVERGENCE
                           ...
                           if ((RSIlower>RSIhigher) && (goLong==true)&& (notrade==false)&& (notDiverging==false)&& (adxtrigger>inpasxCrosstrigger)
                           && (priceExtreme==true))
