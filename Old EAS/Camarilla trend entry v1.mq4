...
input  double              inpSLfactor= 0.25;// enter factor of daily range to act as stoploss
                ...
                (stopvalue< inpMaxSpread)&&
                  (pass==false)) 
                         ...
                         {  
                               ...
                               double stp1= (iHigh(Symbol(),Period(),1)-iLow(Symbol(),Period(),1))*inpSLfactor;
                  ...
                  if (
                      ...
                      (shortpass==false)) 
                           
                             {
                                    ...
                                    double stp= (iHigh(Symbol(),Period(),1)-iLow(Symbol(),Period(),1))*inpSLfactor;
