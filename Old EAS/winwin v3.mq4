...
input double   inpOldStopLoss = 170;// Enter stop loss for old order in pips
input double   inpOldTakeProfit= 500;// Enter take profit for old order in pips
                  ...
                  if (Bid >=BuyClosePrice)
                   //  if (MarketInfo(Symbol(),MODE_SPREAD)<inpMaxSpread)
                        ...
                        if (Order== true)
                           ...
                           sellStopLoss = NormalizeDouble(Bid+inpHedgeStopLoss*Point*10, Digits);
                           SellTakeProfit= NormalizeDouble(Bid-inpHedgeTakeProfit*Point*10,Digits);
                  ...
                  if (Ask <=SellClosePrice)
                     //if (MarketInfo(Symbol(),MODE_SPREAD)<inpMaxSpread)
                        ...
                        if (Order== true)
                           ...
                           buyStopLoss = NormalizeDouble(Ask-inpHedgeStopLoss*Point*10, Digits);
                           buyTakeProfit= NormalizeDouble(Ask+inpHedgeTakeProfit*Point*10,Digits);
