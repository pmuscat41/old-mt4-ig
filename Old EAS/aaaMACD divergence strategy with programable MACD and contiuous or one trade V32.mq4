...
double  nowminusdi ;
 ...
 Comment (" Spread =  "+MarketInfo(Symbol(),MODE_SPREAD)+ "  Minimum stop = "+  MarketInfo(Symbol(),MODE_SPREAD));
  ...
  
  {
      ...
      Alert ("Divergence found - waiting for MACD cross to enter Long");
   ...
   for (int t=2;t<40;t++)
         {
                   ...
                   priceExtreme=false;
                    ...
                    if ((bar1==1)&&(MACDLow>MACDHigh) && (goShort==true) &&  (notrade==false)&& (notDiverging==false) && 
                    (adxtrigger<inpasxCrosstrigger) && (priceExtreme==true)) 
                        ...
                        divergence=false;
                                ...
                                double Price1 =iLow (Symbol(),Period(),bar1);
                                double Price2=iLow (Symbol(),Period(),bar2);
                                if (Price1<Price2)
                                     {
                                       higherLow = bar2; 
                                       lowerLow = bar1;
                     ...
                     if ((bar1==1)&&(MACDLower>MACDHigher) && (goLong==true)&& (notrade==false)&& (notDiverging==false)&& (adxtrigger<inpasxCrosstrigger)&& (priceExtreme==true))
