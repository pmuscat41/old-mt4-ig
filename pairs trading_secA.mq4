...
//ord2= orderExecute (ORDER_TYPE_SELL,Sec_b,0,0,1,inpTradeComments,inpMagicNumber);
...
//while (ord1<0)
//{
//ord1= orderExecute (ORDER_TYPE_BUY,Sec_b,0,0,1,inpTradeComments,inpMagicNumber);
//}
      ...
      while (Closing <0)

         {
          ...
          //  int Closing2= OrderClose (ord1,OrderLots(),AS,10);
            if (Closing>0){Status=WAITING;return;}}
            }
